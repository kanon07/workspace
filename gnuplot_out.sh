...
#keyfont="set key left top font 'Arial, 18';"
...
#for i in 1 2
 #   do
co_throughput="set grid; set xlabel 'Time [s]'; $lmargin set ylabel 'Throughput [Mbps]'; set yrange [0:1200]; plot $range '$bbrth' using 0:7 with lines lc 3 $wid title 'TCP BBR'; replot '$cubicth' using 0:7 with lines dt (10,5) lc 4 $wid title 'CUBIC TCP'; $fonts set terminal $extension1; set out '$deta/throughput.$dot_extension1'; replot"

throughput1="set grid; set xlabel 'Time [s]'; $lmargin set ylabel 'Throughput [Mbps]'; set yrange [0:1200]; plot $range '$bbrth' using 0:7 with lines lc 3 $wid title 'TCP BBR'; $fonts set terminal $extension1 ; set out '$deta/throughput.$dot_extension1'; replot"

throughput2="set grid; set xlabel 'Time [s]'; set ylabel 'Throughput [Mbps]'; set yrange [0:1200]; plot $range '$cubicth' using 0:7 with lines lc 4 $wid title 'CUBIC TCP'; $fonts set terminal $extension1; set out '$deta/throughput.$dot_extension1'; replot"


co_cwnd="set grid; set xlabel 'Time [s]'; $lmargin  set ylabel 'Congestion window size [segment]'; plot $range '$bbr' using 1:28 with lines lc 3 $wid title 'TCP BBR'; replot '$cubicdir/time_kernel.txt' using 1:10 with lines dt (10,5) $wid lc 4 title 'CUBIC TCP'; $fonts set terminal $extension1; set out '$deta/cwnd.$dot_extension1'; replot"

cwnd1="set grid; set xlabel 'Time [s]'; $lmargin set ylabel 'Cwnd [segment]'; plot $range '$bbr' using 1:28 with lines lc 3 $wid title 'TCP BBR'; $fonts set terminal $extension1; set out '$deta/cwnd.$dot_extension1'; replot"

cwnd2="set grid; set xlabel 'Time [s]'; $lmargin set ylabel 'Congestion window size [segment]'; plot $range '$cubicdir/time_kernel.txt' using 1:10 with lines $wid lc 4 title 'CUBIC TCP'; $fonts set terminal $extension1; set out '$deta/cwnd.$dot_extension1'; replot"
...
btl_rtprop="set grid; $lmargin set xlabel 'Time [s]'; set ylabel 'Btlbw [Mbit/s]'; plot $range '$bbr' using 1:12 with lines $wid lc 1 title 'Btlbw';  $fonts set terminal $extension1; set out '$deta/btl_mode.$dot_extension1'; replot"

queue="set grid; set xlabel 'Time [s]'; $lmargin set ylabel 'Queuelength [packets]'; plot $range '$queuedir/time_kernel.txt' using 1:42 with lines $wid lc 6 title 'queue'; $fonts set terminal $extension1; set out '$deta/queue.$dot_extension1'; replot"
...
srtt="set grid; $rmargin $lmargin set xlabel 'Time [s]'; set ylabel 'RTT [ms]'; plot $rttrange $range '$bbr' using 1:(\$26/1000.0) with lines $wid lc 7 title 'RTT';replot '$bbr' using 1:(\$14/1000.0) with lines dt (10,5) $wid lc 2 title 'RTprop'; set y2tics; $rtty2range set y2label 'RTT/RTprop'; replot '$bbr' using 1:(\$26/\$14) axis x1y2 with lines dt (10,10,3,10) $wid title 'RTT/RTprop';  $fonts set terminal $extension1; set out '$deta/srtt.$dot_extension1'; replot"

delirate="set grid; set xlabel 'Time [s]'; $lmargin $rmargin ;set ylabel 'deliverd [packets]'; plot $range '$bbr' using 1:30 with lines $wid lc 3 title 'deliverd'; set y2tics; set y2label 'interval [us]'; replot '$bbr' using 1:36 axis x1y2 with lines $wid lc 4 title 'interval'; $fonts set terminal $extension1; set out '$deta/delirate.$dot_extension1'; replot"
#delirate="set grid; set xlabel 'Time [s]'; set ylabel 'deliverd [packets]'; plot $range '$bbr' using 1:30 with lines $wid lc 3 title 'deliverd'; set y2tics; set format y2 '10^{%L}' ;set y2label 'interval [ms]'; replot '$bbr' using 1:32 axis x1y2 with lines $wid lc 4 title 'interval'; $fonts set terminal $extension1; set out '$deta/delirate.$dot_extension1'; replot"
